...
if __name__ == '__main__':
  ...
  beam_keys = {
      "POWER":  "00011101111010100011000011001111",
      "MUTE":   "00011101111010101011000001001111",
      "REW":    "00011101111010100011100011000111",
      "PLAY":   "00011101111010100001100011100111",
      "FORW":   "00011101111010101011100001000111",
      "UP":     "00011101111010100000100011110111",
      "LEFT":   "00011101111010101000100001110111",
      "OK":     "00011101111010100100100010110111",
      "RIGHT":  "00011101111010101100100000110111",
      "DOWN":   "00011101111010100010100011010111",
      "SOURCE": "00011101111010100111000010001111",
      "MENU":   "00011101111010100110100010010111",
      "EXIT":   "00011101111010101110100000010111",
      "VOL-":   "00011101111010100111100010000111",
      "VOL+":   "00011101111010101111100000000111",
  }

  # Store all forbidden sequences for quick lookup
  forbidden = set(beam_keys.values())

  # Generate the map, excluding any forbidden sequences
  bit_map = {
    i: full_seq
    for i in range(1, 2**13)
    if (full_seq := f'{prefix}{i:013b}{suffix}') not in forbidden
  }
  for k in list(bit_map.keys())[:8192]:
    ir_send(bit_map[k])
