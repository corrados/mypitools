...
def send_command(device, command, repeat=1):
    ...
    if device == "BAR": # Philips soundbar HTL2163B
      ...
      tv_keys = {
        ...
        "VOLUMEUP":    "00000010111111010101100010100111", # 0x02FD58A7 0x00000000
        "VOLUMEDOWN":  "00000010111111010111100010000111", # 0x02FD7887 0x00000000
        ...
        "PROGRAMUP":   "00000010111111011101100000100111", # 0x02FDD827 0x00000000
        "PROGRAMDOWN": "00000010111111011111100000000111", # 0x02FDF807 0x00000000
