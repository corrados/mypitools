...
sudo apt-get install tvheadend gnuplot build-essential fail2ban git hdparm htop libjack-jackd2-dev net-tools nethogs pigpio qjackctl qtbase5-dev qtchooser qt5-qmake unattended-upgrades vim -y
